...
# Which  would you like to load? ( can be found in ~/.oh-my-zsh//*)
# Custom  may be added to ~/.oh-my-zsh/custom//
# Example format: =(rails git textmate ruby lighthouse)
# Add wisely, as too many  slow down shell startup.
plugins=(bower coffee cp docker gem git go npm rbenv sudo vagrant vi-mode yum)
